...
int main(int argc, char *argv[])
{
...
#endif
#ifdef ATEXIT_MAX
	printf("ATEXIT_MAX defined to %ld\n", (long)ATEXIT_MAX+0);
#else
...
#endif
#ifdef CHILD_MAX
	printf("CHILD_MAX defined to %ld\n", (long)CHILD_MAX+0);
#else
...
#endif
#ifdef CLK_TICK
	printf("CLK_TICK defined to %ld\n", (long)CLK_TICK+0);
#else
	printf("no symbol for CLK_TICK\n");
#endif
#ifdef _SC_CLK_TICK
	pr_sysconf("CLK_TICK = ", _SC_CLK_TICK);
#else
	printf("no symbol for _SC_CLK_TICK\n");
#endif
#ifdef COLL_WEIGHTS_MAX
	printf("COLL_WEIGHTS_MAX defined to %ld\n", (long)COLL_WEIGHTS_MAX+0);
#else
	...
	printf("DELAYTIMER_MAX defined to %ld\n", (long)DELAYTIMER_MAX+0);
#else
...
#endif
#ifdef HOST_NAME_MAX
	printf("HOST_NAME_MAX defined to %ld\n", (long)HOST_NAME_MAX+0);
#else
	...
	printf("LOGIN_NAME_MAX defined to %ld\n", (long)LOGIN_NAME_MAX+0);
#else
...
#endif
#ifdef NGROUPS_MAX
	printf("NGROUPS_MAX defined to %ld\n", (long)NGROUPS_MAX+0);
#else
...
#endif
#ifdef PAGE_SIZE
	printf("PAGE_SIZE defined to %ld\n", (long)PAGE_SIZE+0);
#else
...
#endif
#ifdef RE_DUP_MAX
	printf("RE_DUP_MAX defined to %ld\n", (long)RE_DUP_MAX+0);
#else
...
#endif
#ifdef RTSIG_MAX
	printf("RTSIG_MAX defined to %ld\n", (long)RTSIG_MAX+0);
#else
...
#endif
#ifdef SEM_NSEMS_MAX
	printf("SEM_NSEMS_MAX defined to %ld\n", (long)SEM_NSEMS_MAX+0);
#else
...
#endif
#ifdef SEM_VALUE_MAX
	printf("SEM_VALUE_MAX defined to %ld\n", (long)SEM_VALUE_MAX+0);
#else
...
#endif
#ifdef SIGQUEUE_MAX
	printf("SIGQUEUE_MAX defined to %ld\n", (long)SIGQUEUE_MAX+0);
#else
...
#endif
#ifdef STREAM_MAX
	printf("STREAM_MAX defined to %ld\n", (long)STREAM_MAX+0);
#else
...
#endif
#ifdef SYMLOOP_MAX
	printf("SYMLOOP_MAX defined to %ld\n", (long)SYMLOOP_MAX+0);
#else
...
#endif
#ifdef TIMER_MAX
	printf("TIMER_MAX defined to %ld\n", (long)TIMER_MAX+0);
#else
...
#endif
#ifdef TTY_NAME_MAX
	printf("TTY_NAME_MAX defined to %ld\n", (long)TTY_NAME_MAX+0);
#else
...
#endif
#ifdef TZNAME_MAX
	printf("TZNAME_MAX defined to %ld\n", (long)TZNAME_MAX+0);
#else
...
#endif
#ifdef FILESIZEBITS
	printf("FILESIZEBITS defined to %ld\n", (long)FILESIZEBITS+0);
#else
...
#endif
#ifdef MAX_CANON
	printf("MAX_CANON defined to %ld\n", (long)MAX_CANON+0);
#else
...
#endif
#ifdef MAX_INPUT
	printf("MAX_INPUT defined to %ld\n", (long)MAX_INPUT+0);
#else
	...
	printf("_POSIX_TIMESTAMP_RESOLUTION defined to %ld\n", (long)_POSIX_TIMESTAMP_RESOLUTION+0);
#else
...
#endif
#ifdef SYMLINK_MAX
	printf("SYMLINK_MAX defined to %ld\n", (long)SYMLINK_MAX+0);
#else
